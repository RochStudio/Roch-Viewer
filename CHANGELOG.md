...
- Set the compact window to 750 × 800, kept Summary free of scrolling, aligned the utility buttons with the tabs, made longer pages scroll, placed Timings and Training in two columns, and placed Graphics at the bottom of System Info.
